...
const GatePasses = () => {
    ...
    useEffect(() => {
        ...
        setGatePassesTableData(gatePassesTableData.sort((a, b) => new Date(b.date) - new Date(a.date)));
        ...
        <Sidebar>
            ...
            <div className={`bg-base-100 rounded-md shadow-md p-5 lg:p-10 mt-10 ${loading && "hidden"}`}>
                <div className="flex items-center justify-between">
                    ...
                    <button className="btn btn-primary text-white" onClick={() => document.getElementById('gate_pass_modal').showModal()}>
