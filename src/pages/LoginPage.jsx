...
const SidebarElement = ({ role, setRole, icon, text }) => {
    return (
        <div className="flex flex-col items-center justify-center mx-10 max-sm:mx-0" onClick={() => setRole(text)}>
            {icon}
            <p className={`font-semibold ${role == text ? "text-[#3d5e5a]" : "text-white"} transition-colors ease-in-out`}>{text}</p>
        </div>
...
const LoginPage = () => {
    ...
    const sidebarElements = [
        {
            role: "Reception",
            icon: <svg className="size-14 max-sm:size-8" viewBox="0 0 59 41" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        {
            role: "Admin",
            icon: <svg className="size-14 max-sm:size-8" viewBox="0 0 61 68" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        {
            role: "Supervisor",
            icon: <svg className="size-14 max-sm:size-8" viewBox="0 0 67 64" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        {
            role: "Tenant",
            icon: <svg className="size-14 max-sm:size-8" viewBox="0 0 57 73" fill="none" xmlns="http://www.w3.org/2000/svg">
