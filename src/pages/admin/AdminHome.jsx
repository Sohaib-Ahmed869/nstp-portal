...
const AdminHome = () => {
  ...
  const [complaintsComparisonData, setComplaintsComparisonData] = useState({
    pneding: 0,
    resolved: 0,
  });
  ...
  useEffect(() => {
    ...
    async function fetchData() {
      try {
        ...
        setComplaintStats({
          mttr: {
            general: formatMTTR(dashboard.complaints.mttr.general),
            service: formatMTTR(dashboard.complaints.mttr.service),
          }
        });
          ...
          <div className="mb-3 grid grid-cols-1 gap-6 lg:grid-cols-7">
            ...
            <div className=" md:col-span-3">
              <div className="mb-3 grid grid-cols-2 gap-3 md:grid-cols-3">
                ...
                <div className=" h-full card p-5 flex flex-col justify-center  mb-4 md:mb-0">
                  <div className="flex gap-3 items-center">
                    <IdentificationIcon className="size-9  text-primary" />
                ...
                <div className="h-full card p-5 flex flex-col justify-center mb-4 md:mb-0">
                  <div className="flex gap-3 items-center">
                    <ArrowPathRoundedSquareIcon className="size-9  text-primary" />
                ...
                <div className=" col-span-2 md:col-span-1 h-full  card p-5  flex flex-col justify-center mb-4 md:mb-0">
                  <div className="flex gap-3 items-center">
                    <ArchiveBoxArrowDownIcon className="size-9  text-primary" />
              ...
              <div className="mb-3 grid grid-cols-2 gap-3">
                <div className="h-full card p-5 flex flex-col justify-center mb-4 md:mb-0">
                  <p className="font-semibold font-lg mb-0">Services Complaints MTTR</p>
                  <div className="flex gap-3 items-center">
                    <p className="font-semibold text-4xl mb-0">{complaintStats?.mttr?.general?.number || "0"}</p>
                    <ClockIcon className="size-9 text-primary" />
                  </div>
                  <p className="font-semibold font-sm opacity-50 mb-0">{complaintStats?.mttr?.general?.unit || "minutes"}</p>
                </div>
                <div className="h-full card p-5 flex flex-col justify-center mb-4 md:mb-0">
                  <p className="font-semibold font-lg mb-0">General Complaints MTTR</p>
                  <div className="flex gap-3 items-center">
                    <p className="font-semibold text-4xl mb-0">{complaintStats?.mttr?.service?.number || "0"}</p>
                    <ClockIcon className="size-9 text-primary" />
                  </div>
                  <p className="font-semibold font-sm opacity-50 mb-0">{complaintStats?.mttr?.service?.unit || "minutes"}</p>
                </div>
              </div>

              <div className="card p-5 col-span-3">
                <ComparativeChart title={"Complaints"} comparisonData={complaintsComparisonData} link={"complaints"} />
              </div>
            </div>
