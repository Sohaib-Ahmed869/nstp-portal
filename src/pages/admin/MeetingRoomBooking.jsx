...
/**
|--------------------------------------------------
| THERE IS NO DIFF BETWEEN THIS AND THE RECP ONE
EXCEPT THAT THIS DOES NOT Have the table to approve and view
booking requests. this should be merged with the recp one as one reusbale component.
Also ideally please move the currently selected meeting room to be in params.
|--------------------------------------------------
*/
