...
const NewsFeed = () => {
  ...
  return (
    <div className="bg-base-100 min-h-full max-h-full overflow-y-scroll rounded-md shadow-md border-t flex flex-col gap-5 border-t-gray-200 dark:shadow-2xl dark:border-none  p-5">
